...
public class UserController {
    ...
    @GetMapping("/userCash")
    public Double getAllMoneyFromAccounts(@RequestParam Long userId, @RequestParam Currency currency) throws UserNotFoundException {
        return userFacade.getAllCashBalance(userId, currency);
    }
}
